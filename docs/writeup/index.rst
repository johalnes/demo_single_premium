...
.. note::
   ...
   include different advice of best practices and what a data science project should include, regardless if the end result is an analysis or package. 
   Edit / add / remove as needed. The table of contents is
